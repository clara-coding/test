...
public class Penalty
{
  ...
  public Penalty(float aAmount, Transaction aTransaction, Order aOrder)
  {
    ...
    {
      throw new RuntimeException("Unable to create penalty due to transaction. See http://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
    }
    boolean didAddOrder = setOrder(aOrder);
    if (!didAddOrder)
    {
      throw new RuntimeException("Unable to create penalty due to order. See http://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
    }
  }
